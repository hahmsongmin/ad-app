...
export const AdminColumns = [
  { field: "NO", type: "number", width: COLUMNS_WIDTH },
  { field: "수업명", type: "string", width: COLUMNS_WIDTH, editable: true },
  { field: "시작시간", type: "string", width: COLUMNS_WIDTH, editable: true },
  { field: "종료시간", type: "string", width: COLUMNS_WIDTH, editable: true },
];
